...
const inputStyles = {
  main: "bg-base rounded-lg border-2 border-default focus:border-2 focus:border-borderFocus placeholder:text-muted text-primary leading-[1.3] hover:border-hover",
