...
const btnStyles = {
  primary: "justify-center bg-primaryBg px-3 py-2 text-base font-medium border-2 border-primaryBg rounded-xl hover:shadow-btnHover disabled:bg-disabled disabled:text-muted disabled:border-disabled ",
