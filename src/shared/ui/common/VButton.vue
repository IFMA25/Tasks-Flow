...
const btnStyles = {
  primary: "justify-center bg-primaryBg py-3 px-4 text-base font-medium rounded-xl hover:shadow-btnHover disabled:bg-disabled disabled:text-muted disabled:border-disabled ",
